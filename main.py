...
def efi_backtesting():
    ...
    for i  in range(50):
        ...
        stock_codes = list(set(stock_codes + ['603121', '002379', '002765', '600539', '002119', '000429', '600184',
                                              ...
                                              '002594', '600595','002112', '002361']))
        # #days=90, 龙虎榜最近4个月符合条件股票  0.21 0.71, win_rate > 0.47, 交易>4
        stock_codes = list(set(stock_codes + ['603322', '002765', '600601']))
        # 高胜率
        stock_codes = list(set(stock_codes + ['002249', '601218', '600415', '002278', '600689', '603336', '603839']))
